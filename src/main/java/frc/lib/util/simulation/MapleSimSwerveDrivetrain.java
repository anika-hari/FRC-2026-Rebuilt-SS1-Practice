package frc.lib.util.simulation;
...
public class MapleSimSwerveDrivetrain {
     ...
     *     DCMotor.getKrakenX60Foc()
     *     </code>
     * @param driveSimMotorType the {@link TalonFXSimState.MotorType} for the drive motor simulation
     * @param steerSimMotorType the {@link TalonFXSimState.MotorType} for the steer motor simulation
    ...
    public MapleSimSwerveDrivetrain(
            ...
            TalonFXSimState.MotorType driveSimMotorType,
            TalonFXSimState.MotorType steerSimMotorType,
            double wheelCOF,
        ...
        for (int i = 0; i < this.simModules.length; i++)
            simModules[i] = new SimSwerveModule(
                    moduleConstants[i], moduleSimulations[i], modules[i], driveSimMotorType, steerSimMotorType);
    ...
    protected static class SimSwerveModule {
        ...
        public SimSwerveModule(
                ...
                TalonFXSimState.MotorType driveMotorType,
                TalonFXSimState.MotorType steerMotorType) {
            this.moduleConstant = moduleConstant;
            this.moduleSimulation = moduleSimulation;
            moduleSimulation.useDriveMotorController(
                    new TalonFXMotorControllerSim(module.getDriveMotor(), driveMotorType));
            moduleSimulation.useSteerMotorController(new TalonFXMotorControllerWithRemoteCanCoderSim(
                    module.getSteerMotor(), module.getEncoder(), steerMotorType));
        }
    }
    ...
    public static class TalonFXMotorControllerSim implements SimulatedMotorController {
        ...
        public TalonFXMotorControllerSim(TalonFX talonFX, TalonFXSimState.MotorType motorType) {
    ...
    public static class TalonFXMotorControllerWithRemoteCanCoderSim extends TalonFXMotorControllerSim {
        ...
        public TalonFXMotorControllerWithRemoteCanCoderSim(
                TalonFX talonFX, CANcoder cancoder, TalonFXSimState.MotorType motorType) {
            super(talonFX, motorType);
