 ...
 */
public class DisabledMotorIO implements MotorIO {
    ...
    public void setMotionMagicSetpoint(
        ...
        // + velocity + ", acceleration=" + acceleration + ", jerk=" + jerk + ", slot=" + slot + ", feedforward="
        // + feedforward);
    }
    ...
    public void setVelocitySetpoint(double unitsPerSecond, int slot) {
        // System.out.println(
        // "DisabledMotorIO: setVelocitySetpoint called with unitsPerSecond=" + unitsPerSecond + ", slot=" + slot);
    }
