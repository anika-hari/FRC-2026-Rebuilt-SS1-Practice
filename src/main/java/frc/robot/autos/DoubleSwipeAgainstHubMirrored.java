...
public class DoubleSwipeAgainstHubMirrored extends BaseAuto {
    Path path_1 = new Path("2swipe_first_aggressive");
    Path path_2 = new Path("2swipe-second-againsthub");

    public DoubleSwipeAgainstHubMirrored(RobotContainer container) {
        super(container);
