...
public class DoubleSwipeAggroMirrored extends BaseAuto {

    Path path_1 = new Path("2swipe_first_aggressive");
    Path path_2 = new Path("2swipe_second_lowerCenter_conservative");

    public DoubleSwipeAggroMirrored(RobotContainer container) {
        super(container);
