...
public class DoubleSwipeCrossMirrored extends BaseAuto {

    Path path_1 = new Path("2swipe_first_scoop");
    Path path_2 = new Path("2swipe_second_scoop_cross");

    public DoubleSwipeCrossMirrored(RobotContainer container) {
        super(container);
