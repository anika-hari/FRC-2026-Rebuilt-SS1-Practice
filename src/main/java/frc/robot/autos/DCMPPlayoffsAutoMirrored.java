...
public class DCMPPlayoffsAutoMirrored extends BaseAuto {

    Path path_1 = new Path("2swipe_first_aggressive");
    Path path_2 = new Path("2swipe_second_scoop");

    public DCMPPlayoffsAutoMirrored(RobotContainer container) {
        super(container);
        path_1.mirror();
        path_2.mirror();
    }
